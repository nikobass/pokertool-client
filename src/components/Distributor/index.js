    ...
    <main className="distributor">
        <form className="distributor__form">
            ...
            <div className="distributor__form__container">
                <DistributorChipElement index={0}/>
                <DistributorChipElement index={1}/>
                <DistributorChipElement index={2}/>
                <DistributorChipElement index={3}/>
                <DistributorChipElement index={4}/>
