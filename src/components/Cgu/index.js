...
const Cgu = () => (
  <main className="cgu">  
    <h1 className="cgu__mainTitle">Conditions générales d'utilisation</h1>
    <h2 className="cgu__articleTitle">ARTICLE 1 : Objet</h2>
    <p className="cgu__articleContent">
    ...
    <h2 className="cgu__articleTitle">ARTICLE 2 : Mentions légales</h2>
    <p className="cgu__articleContent">
      L'édition du site Poker Tool est assurée par la promotion "Robin" pour projet de fin d'études.
    </p>     

    <h2 className="cgu__articleTitle">ARTICLE 3 : Définitions</h2>
    <p className="cgu__articleContent">
    ...
    <h2 className="cgu__articleTitle">ARTICLE 4 : accès aux services</h2>
    <p className="cgu__articleContent">
    ...
    <h2 className="cgu__articleTitle">ARTICLE 5 : Propriété intellectuelle</h2>
    <p className="cgu__articleContent">
    ...
    <h2 className="cgu__articleTitle">ARTICLE 6 : Données personnelles</h2>
    <p className="cgu__articleContent">
    ...
    <h2 className="cgu__articleTitle">ARTICLE 7 : Responsabilité et force majeure</h2>
    <p className="cgu__articleContent">
    ...
    <h2 className="cgu__articleTitle">ARTICLE 8 : Liens hypertextes</h2>
    <p className="cgu__articleContent">
    ...
    <h2 className="cgu__articleTitle">ARTICLE 9 : Évolution du contrat</h2> 
    <p className="cgu__articleContent">
    ...
    <h2 className="cgu__articleTitle">ARTICLE 10 : Durée</h2>
    <p className="cgu__articleContent">
