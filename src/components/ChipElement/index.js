...
const ChipElement = ({
  ...
  <li className="chipElement">   
    <svg className="chipElement__img" fill={color} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 296.477 296.477" style={{ enableBackground: 'new 0 0 296.477 296.477' }} xmlSpace="preserve">
              <g>
      ...
      <div className="chipElement__field">
        <label className="chipElement__field__label" htmlFor="color">Couleur</label>    
        <input 
          type="color"
          name="color" 
          value={color}
      ...
      <div className="chipElement__field">
        <label className="chipElement__field__label" htmlFor="value">Valeur</label>
        <input 
          min="1"
          type="number"
          name="value" 
